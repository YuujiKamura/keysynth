...
fn piece_assistant_internal() -> Vec<NoteEvent> {
    ...
    let a_melody: &[(f32, u8, f32)] = &[
        ...
        (4.5, 70, 0.5), // C5, B♭4
        (5.0, 68, 0.5),
        (5.5, 66, 0.5), // A♭4, G♭4 (blue note, ♭5 of C)
        (6.0, 65, 1.5), // F4 hold
        ...
        (12.0, 71, 0.5),
        (12.5, 70, 0.5), // B4, B♭4 (chromatic into V)
        (13.0, 72, 0.5),
        (13.5, 68, 0.5), // C5, A♭4
    ...
    let push_at = |v: &mut Vec<NoteEvent>,
                   off: f32,
                   melody: &[(f32, u8, f32)],
                   bass: &[(f32, u8, f32)],
                   chords: &[(f32, [u8; 3], f32)]| {
...
fn piece_gemini_nocturne() -> Vec<NoteEvent> {
    ...
    let b_chords: &[(f32, &'static [u8], f32)] = &[
        ...
        (37.0, GS7, 1.0),
        (38.0, GS7, 1.0),
        (39.0, GS7, 1.0), // Using G#7 as B7-ish proxy or V of iii
        (41.0, AMAJ, 1.0),
        (42.0, AMAJ, 1.0),
        (43.0, AMAJ, 1.0),
        (45.0, GS7, 1.0),
